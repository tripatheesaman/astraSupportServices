<x-layout.user-layout>
    <section class="relative p-8 sm:p-12 lg:p-24 xl:p-32 z-10 overflow-hidden bg-primary py-12 sm:py-20 lg:py-32 min-h-screen">
        <div class="container mx-auto">
            <div class="flex flex-wrap -mx-4 lg:justify-between">
                <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                    <div class="mb-6 sm:mb-12 lg:mb-0 max-w-[570px]">
                        <span class="block mb-2 sm:mb-4 font-mono font-extrabold text-4xl sm:text-6xl text-reddish">
                            Contact Us
                        </span>

                        <p class="text-base sm:text-lg md:text-base lg:text-lg xl:text-base leading-relaxed text-white mb-6 sm:mb-9">
                            We'd love to hear from you and discuss how we can bring your vision to life. Whether you have questions or ideas to share, feel free to reach out.
                        </p>
                        <div class="mb-6 sm:mb-8 flex w-full max-w-[370px]">
                            <div class="bg-secondary text-white mr-4 sm:mr-6 flex h-[60px] sm:h-[70px] w-[60px] sm:w-[70px] items-center justify-center overflow-hidden rounded">
                            ...
                            <div class="w-full">
                                <h4 class="mb-1 text-lg sm:text-xl font-bold text-reddish">
                                    Our Location
                                </h4>
                                <p class="text-base sm:text-lg text-white">
                                    7 Fountain drive, Beveridge, 3753
                                </p>
                            </div>
                        </div>
                        <div class="mb-6 sm:mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-base sm:text-lg text-white">
                                    <a href="tel:+4733378901">Phone Number: <span class="underline-offset-auto underline ">(+47) 333 78 901</span></a>
                                </p>
                            </div>
                        </div>
                        <div class="mb-6 sm:mb-8 flex w-full max-w-[370px]">
                            ...
                            <div class="w-full">
                                ...
                                <p class="text-base sm:text-lg text-white">
                                    <a href="mailto:sth@sth.com"><span class=" underline ">admin@astrasupportservices.com.au</span></a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div class="relative p-4 bg-white rounded-lg shadow-lg sm:p-12">
                        <form>
                            <div class="mb-4 sm:mb-6">
                                <input type="text" placeholder="Your Name" class="border-stroke text-body-color focus:border-primary w-full rounded border py-3 px-3 sm:px-4 text-base outline-none" />
                            </div>
                            <div class="mb-4 sm:mb-6">
                                <input type="email" placeholder="Your Email" class="border-stroke text-body-color focus:border-primary w-full rounded border py-3 px-3 sm:px-4 text-base outline-none" />
                            </div>
                            <div class="mb-4 sm:mb-6">
                                <input type="email" placeholder="Your Phone Number" class="border-stroke text-body-color focus:border-primary w-full rounded border py-3 px-3 sm:px-4 text-base outline-none" />
                            </div>
                            <div class="mb-4 sm:mb-6">
                                <textarea placeholder="Your Message" class="border-stroke text-body-color focus:border-primary w-full rounded border py-3 px-3 sm:px-4 text-base h-[150px] outline-none"></textarea>
                            </div>
                            <div>
                                <button type="submit" class="text-white font-mono font-semibold w-full bg-primary hover:bg-secondary py-3 text-base rounded focus:outline-none transition-colors duration-300">
                                    Send Message
                                </button>
                            </div>
                        </form>
